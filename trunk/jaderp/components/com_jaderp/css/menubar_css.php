...
#save div#TaskIcon{background:url(../../../images/jaderp/icons/toolbar/<?php echo $toolBarIconStyle; ?>/task_save.png) 0px 2px no-repeat;}
#cancel div#TaskIcon {background:url(../../../images/jaderp/icons/toolbar/<?php echo $toolBarIconStyle; ?>/task_cancel.png) 0px 2px no-repeat;}
#edit div#TaskIcon {background:url(../../../images/jaderp/icons/toolbar/<?php echo $toolBarIconStyle; ?>/task_edit.png) 0px 2px no-repeat;}	
...
#lock div#TaskIcon{background:url(../../../images/jaderp/icons/toolbar/<?php echo $toolBarIconStyle; ?>/task_lock.png) 0px 2px no-repeat;}

...
<div id="JAdERPlist">
  <form action="index.php?option=com_jaderp&func=Suppliers&task=manage" method="post" name="adminForm" id="adminForm">
    ...
    <table cellspacing="1" class="adminlist">
      ...
      <?php
		...
		{
			$hlink = 'index.php?option=com_jaderp&func=Suppliers&task=edit&cid='.$row["id"]."&menuid=".$this->menuid;
        	echo '<tr class="row'.$k.'">';
